...
const infoBoxPresets = [
	...
	},
    {
        ...
        innerBlocks: [
			{ name: 'uagb/advanced-heading', attributes: { headingAlign: '', headingColor: '#000', subHeadingColor: '#000', blockBottomPadding:0, headingDescToggle:true, headingDesc: 'Prefix',subHeadSpace:0 } },
			{ name: 'uagb/advanced-heading', attributes: { headingAlign: '', headingTitleToggle: false, subHeadingColor: '#000', headingDescToggle:true,headingDesc: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.' } } ,
			{ name: 'uagb/buttons', attributes: { btn_count: 1, align: '' }},
		],
    ...
    },
    {
        ...
        innerBlocks: [
			{ name: 'uagb/advanced-heading', attributes: { headingAlign: '', headingColor: '#ffffff', subHeadingColor: '#fff', blockBottomPadding:0, headingDescToggle:true, headingDesc: 'prefix',subHeadSpace:0 } },
			{ name: 'uagb/advanced-heading', attributes: { headingAlign: '', headingTitleToggle: false, subHeadingColor: '#fff', headingDescToggle:true,headingDesc: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.' } } ,
			{ name: 'uagb/buttons', attributes: { btn_count: 1, align: '' }},
		],
    ...
    },
    {
        ...
        attributes: [
            { label: 'align', value: 'left' },
            { label: 'backgroundType', value: 'color' },    
            { label: 'backgroundColor', value: '#78F071AB'}
        ],
        innerBlocks: [
			{ name: 'uagb/advanced-heading', attributes: { headingAlign: '', headingColor: '#DA3232', blockBottomPadding:0, headingDescToggle:false, } },
			{ name: 'uagb/advanced-heading', attributes: { headingAlign: '', headingTitleToggle: false, subHeadingColor: '#DA3232', headingDescToggle:true,headingDesc: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.' } } ,
			{ name: 'uagb/buttons', attributes: { btn_count: 0, align: '' }},
		],
    ...
    },
	{
        ...
        attributes: [
            { label: 'align', value: 'center' },
            { label: 'backgroundType', value: 'color' },    
            { label: 'backgroundColor', value: '#5240403B'}
        ],
        innerBlocks: [
			{ name: 'uagb/advanced-heading', attributes: { headingAlign: '', headingColor: '#000000', blockBottomPadding:0, headingDescToggle:false, } },
			{ name: 'uagb/advanced-heading', attributes: { headingAlign: '', headingTitleToggle: false, subHeadingColor: '#000000', headingDescToggle:true,headingDesc: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.' } } ,
			{ name: 'uagb/buttons', attributes: { btn_count: 0, align: '' }},
		],
