...
const rowIcons = {
	'style-1' : ( //Done
		<svg width="24" height="24" viewBox="0 0 24 24" fill="#fff" xmlns="http://www.w3.org/2000/svg">
			...
			<path d="M7.12109 15.521L15.9998 15.4341" stroke="#1E293B" strokeWidth="1" strokeLinecap="round"/>
			<path d="M7.12109 17.5665H16" stroke="#1E293B" strokeWidth="1" strokeLinecap="round"/>
	...
	'style-2' : ( //Done
		<svg width="25" height="24" viewBox="0 0 25 24" fill="#fff" xmlns="http://www.w3.org/2000/svg">
			...
			<path d="M9.10889 4H16.6772" stroke="#1E293B" strokeWidth="1" strokeLinecap="round"/>
			...
			<path d="M10.051 8.00001C10.051 8.1657 9.91667 8.30002 9.75098 8.30002C9.58529 8.30002 9.45098 8.1657 9.45098 8.00001C9.45098 7.83432 9.58529 7.7 9.75098 7.7C9.91667 7.7 10.051 7.83432 10.051 8.00001Z" stroke="#1E293B" strokeWidth="1" strokeLinecap="round"/>
			<path d="M10.051 12C10.051 12.1657 9.91667 12.3 9.75098 12.3C9.58529 12.3 9.45098 12.1657 9.45098 12C9.45098 11.8343 9.58529 11.7 9.75098 11.7C9.91667 11.7 10.051 11.8343 10.051 12Z" stroke="#1E293B" strokeWidth="1" strokeLinecap="round"/>
			<path d="M10.051 16C10.051 16.1657 9.91667 16.3 9.75098 16.3C9.58529 16.3 9.45098 16.1657 9.45098 16C9.45098 15.8343 9.58529 15.7 9.75098 15.7C9.91667 15.7 10.051 15.8343 10.051 16Z" stroke="#1E293B" strokeWidth="1" strokeLinecap="round"/>
			<path d="M9.18877 20.1072C9.18877 19.923 9.3381 19.7737 9.52231 19.7737H16.2638C16.448 19.7737 16.5974 19.923 16.5974 20.1072C16.5974 20.2914 16.448 20.4408 16.2638 20.4408H9.52231C9.3381 20.4408 9.18877 20.2914 9.18877 20.1072Z" stroke="#1E293B" strokeWidth="1" strokeLinecap="round"/>
			</g>
			<defs>
	...
	'style-5' : ( //Done
		<svg width="25" height="24" viewBox="0 0 25 24" fill="#fff" xmlns="http://www.w3.org/2000/svg">
			...
			<path d="M14.9009 12.6273H22.0754" stroke="#1E293B" strokeWidth="1" strokeLinecap="round"/>
			<path d="M14.9009 14.6599H22.0754" stroke="#1E293B" strokeWidth="1" strokeLinecap="round"/>
			<path d="M14.893 9.725C14.893 9.42174 15.1224 9.17589 15.4055 9.17589C15.6885 9.17589 15.918 9.42174 15.918 9.725C15.918 10.0283 15.6885 10.2741 15.4055 10.2741C15.1224 10.2741 14.893 10.0283 14.893 9.725ZM14.893 9.725C14.893 9.725 14.893 8.90134 15.6617 8.35223" stroke="#1E293B" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
			<path d="M17.5746 9.725C17.5746 9.42174 17.8041 9.17589 18.0871 9.17589C18.3702 9.17589 18.5996 9.42174 18.5996 9.725C18.5996 10.0283 18.3702 10.2741 18.0871 10.2741C17.8041 10.2741 17.5746 10.0283 17.5746 9.725ZM17.5746 9.725C17.5746 9.725 17.5746 8.90134 18.3434 8.35223" stroke="#1E293B" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
			</g>
			<defs>
