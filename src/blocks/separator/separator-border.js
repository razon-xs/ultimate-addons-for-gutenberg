// function separatorStyles(label,amount,color,width) {
//     const styless={
...
//             ),
//     }
//     return label in customSvg ? customSvg[ label ] : '';
// }

// function buildSVG() {
//    const settings =get_settings_for_display();
...
//     const selected_pattern = svgShapes[ customSvg['style'] ];
//     view_box = ( selected_pattern['view_box'] ) ? selected_pattern['view_box'] : '0 0 24 24';
...
// function filterStyles( array, key, value ) {
