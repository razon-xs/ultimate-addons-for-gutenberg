...
const shapes = {
	...
	curve: el(
		...
		el( 'path', {
			className: 'wp-block-uagb-separator__inner',
			d:
				'M1000,4.3V0H0v4.3C0.9,23.1,126.7,99.2,500,100S1000,22.7,1000,4.3z',
		} )
	),
	curve_asymmetrical: el(
		...
		el( 'path', {
			className: 'wp-block-uagb-separator__inner',
			d:
				'M0,0c0,0,0,6,0,6.7c0,18,240.2,93.6,615.2,92.6C989.8,98.5,1000,25,1000,6.7c0-0.7,0-6.7,0-6.7H0z',
		} )
	),
	arrow: el(
		'svg',
	...
	curve_reverse: el(
		...
		el( 'path', {
			className: 'wp-block-uagb-separator__inner',
			d:
				'M937,129.8V-0.1H0v129.9C0,62.6,209.6,8.2,468.4,8.2S936.9,62.6,937,129.8z',
		} )
	),
	curve_asym_reverse: el(
		...
		el( 'path', {
			className: 'wp-block-uagb-separator__inner',
			d:
				'M937.5,124.3V0H0v124.3C0,100.8,227.4,2.9,578.9,4.1C926.9,0.3,937.5,100.4,937.5,124.3z',
		} )
	),
};
